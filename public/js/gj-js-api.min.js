var GJAPI={};
GJAPI.iGameID    = 511953;
GJAPI.bAutoLogin = true;

GJAPI.sAPI="http://gamejolt.com/api/game/v1";GJAPI.sLogName="[Game Jolt API]";GJAPI.iLogStack=20;GJAPI.asQueryParam=function(){for(var a={},f=window.location.search.substring(1).split("&"),c=0;c<f.length;++c){var b=f[c].split("=");"undefined"===typeof a[b[0]]?a[b[0]]=b[1]:"string"===typeof a[b[0]]?a[b[0]]=[a[b[0]],b[1]]:a[b[0]].push(b[1])}return a}();
...
GJAPI.SendRequestEx=function(a,f,c,b,d){a=GJAPI.sAPI+encodeURI(a)+(-1===a.indexOf("/?")?"?":"&")+"game_id="+GJAPI.iGameID+"&format="+c;GJAPI.bActive&&f===GJAPI.SEND_USER&&(a+="&username="+GJAPI.sUserName+"&user_token="+GJAPI.sUserToken);a+="&signature="+hex_md5(a+"c1a0d2202d38bd84c591f5751f62c529");__CreateAjax(a,b,function(b){console.info(GJAPI.sLogName+" <"+a+"> "+b);if(""!==b&&"function"===typeof d)switch(c){case "json":d(eval("("+b+")").response);break;case "dump":var f=b.indexOf("\n"),h=b.substr(0,f-1);b=b.substr(f+
